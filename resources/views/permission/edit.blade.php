...
<form action="{{ route($table.'.update', ['permission' => $data->id ]) }}" method="post" id="formAddPermission">
      ...
      <div class="input-field col s12">
        <input type="text" id="slug" class="validate" name="slug" value="{{ $data->slug }}">
      ...
      <div class="input-field col s12">
        <textarea id="description" class="materialize-textarea validate" name="description">{{ $data->description }}</textarea>
