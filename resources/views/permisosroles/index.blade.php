            ...
            <div class="col s12 permirol">
                <div class="col s6">
                    <div class="row">
                        ...
                        <div is="todo-item" v-for="(perm , index) in temporal" v-bind:permi="perm" v-bind:inde="index"
                            v-bind:posi="false" v-if="perm.permission_role_id">
                        </div>
                    </div>
                </div>
                <div class="col s6">
                    <div class="row">
                        ...
                        <div is="todo-item" v-for="(perm , index) in temporal2" v-bind:permi="perm" v-bind:inde="index"
                            v-bind:posi="true" v-if="perm.permission_role_id == null">
                        </div>
                    </div>
                </div>
            </div>
            ...
            methods: {
                ...
                envio: function(id, permission_role_id, inde, posi) {
                    if (posi) {
                        ...
                        var url =
                            "{{ route('permisosroles.destroy', ['rolesper' => 'permission_role_id']) }}";
